...
const layoutFolderPath : string = path.resolve(__dirname, '../views/layouts');
const defaultLayerPath : string = path.resolve(__dirname, '../views/layouts/index.hbs');
const partialFolderPath : string = path.resolve(__dirname, '../views/partial');
